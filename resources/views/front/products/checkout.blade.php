                        ...
                        <div class="col-lg-6">
                            ...
                            <form name="checkoutForm" id="checkoutForm" action="{{ url('/checkout') }}" method="post">
                                ...
                                <div class="order-table">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($getCartItems as $item)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h6 class="order-h6">
                                                            P{{ $getDiscountAttributePrice['final_price'] * $item['quantity'] }}
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h3 class="order-h3">P{{ $total_price }}</h3>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <h6 class="order-h6">
                                                        ...
                                                        @if (\Illuminate\Support\Facades\Session::has('couponAmount'))
                                                            ...
                                                            <span
                                                                class="couponAmount">P{{ \Illuminate\Support\Facades\Session::get('couponAmount') }}</span>
                                                        @endif
                                                    </h6>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <h3 class="order-h3">
                                                        <strong
                                                            class="grand_total">P{{ $total_price - \Illuminate\Support\Facades\Session::get('couponAmount') }}</strong>
                                    ...
                                    <div>
                                        <input type="radio" class="radio-box" name="payment_gateway" id="gcash"
                                            value="gcash">
                                    ...
                                    <button type="button" id="placeOrder" class="button button-outline-secondary"
...
<script>
    function placeOrder() {
        var selectedPaymentMethod = document.querySelector('input[name="payment_gateway"]:checked').value;

        if (selectedPaymentMethod === 'gcash') {
            // Use AJAX to communicate with your server to generate GCash payment link
            var xhr = new XMLHttpRequest();
            var gcashApiEndpoint = 'YOUR_GCASH_API_ENDPOINT';

            xhr.onreadystatechange = function() {
                if (xhr.readyState === 4 && xhr.status === 200) {
                    var gcashPaymentLink = xhr.responseText;
                    // Redirect the user to the GCash payment link
                    window.location.href = gcashPaymentLink;
                }
            };

            // Make sure to handle the server-side part to generate the GCash payment link
            xhr.open('GET', gcashApiEndpoint, true);
            xhr.send();
        } else {
