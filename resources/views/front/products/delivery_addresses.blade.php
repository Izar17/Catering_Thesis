{{-- This page is 'include'-ed in front/products/checkout.blade.php, and will be used by jQuery AJAX to reload it, check front/js/custom.js --}}
    ...
    <!-- Form-Fields /- -->
    <h4 class="section-h4 deliveryText">Add New Location of venue</h4> {{-- We created that deliveryText CSS class to use the HTML element as a handle for jQuery to change the <h4> content when clicking the Edit button --}}
    <div class="u-s-m-b-24">
        ...
        @else {{-- if there're no already existing delivery addresses --}}
            <label class="label-text newAddress" for="ship-to-different-address">Check to add location of venue</label>
        @endif
        ...
        <form id="addressAddEditForm" action="javascript:;" method="post">
            ...
            <div class="group-inline u-s-m-b-13">
                ...
                <div class="group-2">
                    ...
                    <input type="hidden" id="delivery_country" name="delivery_country" value="Philippines"/>
