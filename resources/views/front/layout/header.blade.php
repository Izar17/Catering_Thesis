            ...
            <div class="row clearfix align-items-center">
                <div class="col-lg-3 col-md-9 col-sm-6">
                    <div class="brand-logo text-lg-center">
                        ...
                        <a href="{{ url('/') }}">
                                <img src="{{ asset('front/images/main-logo/caserole_logo.png') }}"
                                    style="width:60px;height:60px;" alt="CASEROLE" class="app-brand-logo"><strong
                                style="font-family:gabriola;font-size:42px;">CASEROLE</strong>
                        </a>
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-9">
                    <ul class="bottom-nav g-nav u-d-none-lg">
                        <li>
                            <a href="{{ url('search-products?search=new-arrivals') }}">New Catering Setup
                                <span class="superscript-label-new">NEW</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ url('search-products?search=best-sellers') }}">Best Setup
                        ...
                        <li class="mega-position">
                            ...
                            <div class="mega-menu mega-3-colm">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="{{ url('Wedding Design') }}">Wedding Catering</a>
                                    </li>
                                    <li>
                                        <a href="{{ url('Corporate Design') }}">Corporate Catering</a>
                                    </li>
                                    <li>
                                        <a href="{{ url('Social Event Design') }}">Social Event Catering</a>
                                    </li>
                                    <li>
                                        <a href="{{ url('Concession Design') }}">Concession Catering</a>
                                    </li>
                                </ul>
                                <ul>
